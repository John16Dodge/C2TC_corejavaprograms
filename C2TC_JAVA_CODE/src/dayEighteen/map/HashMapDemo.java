...
import dayEight.packages.marketinterface.Student;
class HashMapDemo 
{
	public static void main(String args[]) 
	{
		...
		studentMap.put(10001,new Student(1,"Aniket",78, null));
		studentMap.put(10005,new Student(2,"Sumit",84, null));
		studentMap.put(10006,new Student(3,"Amit",81, null));
		studentMap.put(10003,new Student(5,"Ankit",72, null));
		studentMap.put(10004,new Student(4,"Anil",78, null));
